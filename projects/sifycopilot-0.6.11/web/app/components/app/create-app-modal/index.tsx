        ...
        <div className='flex'>
          ...
          <TooltipPlus
            ...
            popupContent={
              ...
              <div className='flex flex-col max-w-[320px] leading-[18px] text-xs dark:bg-[#3f3f3f]'>
                {/* <div className='text-gray-700'>{t('app.newApp.completionDescription')}</div> */}
                <div className='text-gray-700 dark:bg-[#3f3f3f] dark:text-white'>{t('app.newApp.completionDescription')}</div>
              </div>
            }
          >
            <div
