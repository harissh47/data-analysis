...
const SearchInput: FC<SearchInputProps> = ({
  ...
  return (
    ...
    <div
      className={cn(
        "group flex items-center px-2 h-8 rounded-lg bg-gray-200 dark:bg-[#2c2c2c] hover:bg-gray-300 dark:hover:bg-zinc-800 border border-transparent overflow-hidden",
        focus &&
