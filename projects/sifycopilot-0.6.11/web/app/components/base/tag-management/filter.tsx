      ...
      <div className='relative'>
        ...
        >
          <div className={cn(
            ...
            {/* <div className='text-[13px] leading-[18px] text-gray-700 dark:text-[#E1E1E1]'> */}
            {/* {!value.length && t('common.tag.placeholder')} */}
            {/* All Labels
              {!!value.length && currentTag?.name}
            </div> */}
            <div className='text-[13px] leading-[18px] text-gray-700 dark:text-[#E1E1E1]'>{value.length === 0 ? 'All Label' : currentTag?.name}</div>
