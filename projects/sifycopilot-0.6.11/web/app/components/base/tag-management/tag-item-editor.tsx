      ...
      <div className={cn('shrink-0 flex items-center gap-0.5 pr-1 pl-2 py-1 rounded-lg border border-gray-200 dark:border-[#5F5F5F] text-sm leading-5 text-gray-700')}>
        {!isEditing && (
          <>
            ...
            <div className='text-sm leading-5 text-gray-700 dark:text-[#FCFCFC]'>
              {tag.name}
            </div>
        ...
        {isEditing && (
          <input
            ...
            className='shrink-0 outline-none appearance-none placeholder:text-gray-300 caret-primary-600 dark:text-[#FCFCFC] dark:bg-[#202020]'
            autoFocus
            value={name}
