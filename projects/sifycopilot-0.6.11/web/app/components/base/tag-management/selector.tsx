...
const Panel = (props: PanelProps) => {
  ...
  return (
    ...
    <div className='absolute max-w-screen-xl w-fit bg-white dark:bg-[#202020] border border-gray-200 dark:border-[#5F5F5F] rounded-lg shadow-lg absolute left-0 top-[-200%] transform translate-y-[-10px] z-5 overflow-hidden' onMouseLeave={onMouseLeave}>
      <div className='p-2 border-b-[0.5px] border-black/5 w-full'>
        <SearchInput placeholder={t('common.tag.selectorPlaceholder') || ''} white value={keywords} onChange={handleKeywordsChange} />
      </div>
