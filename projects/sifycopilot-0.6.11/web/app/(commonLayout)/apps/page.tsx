...
const AppList = async () => {
  ...
  return (
    ...
    <div className='relative flex flex-col overflow-y-auto bg-gray-100 shrink h-full w-full grow dark:bg-[#202020]'>
      <Apps />
      {/* <footer className='px-12 py-6 grow-0 shrink-0'>
        ...
        <div className='flex items-center gap-2 mt-3'>
          ...
          <a className={style.socialMediaLink} target='_blank' rel='noopener noreferrer' href='https://github.com'><span className={classNames(style.socialMediaIcon, style.githubIcon)} /></a>
          <a className={style.socialMediaLink} target='_blank' rel='noopener noreferrer' href='https://discord.gg'><span className={classNames(style.socialMediaIcon, style.discordIcon)} /></a>
        </div>
      </footer> */}
    </div >
  )
